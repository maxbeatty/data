...
describe('auth0', () => {
  ...
  //
  //     mockSlackApiUsersInfo.mockImplementationOnce(
  //       (query, cb) => cb(new Error('auth0-add-catch'))
  //     );
  //
  //     addCb({
  //       api: {
  ...
  //           expect(message).toEqual(mockMessage);
  //           expect(text).toEqual(
  //             'Sorry, I\'m afraid I can\'t add other bots, restricted users, or deleted users'
  //           );
  //           resolve();
  //         },
  //       }, mockMessage);
  ...
  //     const mockMessage = { match: ['', 'UABC123'] };
  //     mockSlackApiUsersInfo.mockImplementationOnce(
  //       (query, cb) => cb(new Error('remove-bot-api-fail'))
  //     );
  //
  //     rmCb({
  //       api: {
